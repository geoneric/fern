...
#include "fern/feature/domain_attribute.h"
#include "fern/feature/domain_value.h"
#include "fern/feature/feature.h"
#include "fern/feature/feature_domain.h"
// #include "fern/feature/feature_domain_value.h"
// #include "fern/feature/point_domain.h"
// #include "fern/feature/polygon_domain.h"
#include "fern/feature/scalar_attribute.h"
#include "fern/feature/scalar_domain.h"
#include "fern/feature/scalar_value.h"
...
//     // std::shared_ptr<fern::Polygons> polygons(new fern::Polygons());
//     // fern::Polygon polygon;
// 
//     // {
//     //     polygon.clear();
//     //     auto& point_list(polygon.inners());
//     //     bg::append(point_list, bg::make<fern::Point>(1.0, 1.0));
//     //     bg::append(point_list, bg::make<fern::Point>(1.0, 2.0));
//     //     bg::append(point_list, bg::make<fern::Point>(2.0, 2.0));
//     //     bg::append(point_list, bg::make<fern::Point>(2.0, 1.0));
//     // }
...
//     //     polygon.clear();
//     //     auto& point_list(polygon.inners());
//     //     bg::append(point_list, bg::make<fern::Point>(3.0, 1.0));
//     //     bg::append(point_list, bg::make<fern::Point>(3.0, 2.0));
//     //     bg::append(point_list, bg::make<fern::Point>(4.0, 2.0));
//     //     bg::append(point_list, bg::make<fern::Point>(4.0, 1.0));
//     // }
//     // polygons->push_back(polygon);
// 
//     // std::shared_ptr<fern::PolygonDomain> polygon_domain(
//     //     new fern::PolygonDomain(polygons));
// 
