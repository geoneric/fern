...
//              formatted.
//   \todo      Let the visitor dump this code to main's module. This code adds
//              a dependency on boost_program_options, which the average user
//              won't like.
// */
...
void Module::run(
    std::vector<std::shared_ptr<DataSource>> const& /* data_sources */,
    std::vector<std::shared_ptr<DataSync>> const& /* data_syncs */)
{
}
