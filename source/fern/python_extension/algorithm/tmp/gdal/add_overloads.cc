...
PyObject* add_python_int_gdal_raster_band(
    PyObject* object1,
    PyObject* object2)
{
...
PyObject* add_gdal_raster_band_python_int(
    PyObject* object1,
    PyObject* object2)
{
    return python_object(add(
...
BinaryOperationMap<BinaryAlgorithmKey> add_overloads{
    ...
    ADD_ADD(python_int, gdal_raster_band)
    ...
    ADD_ADD(gdal_raster_band, python_int)
