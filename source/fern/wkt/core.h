...
static auto const left_delimiter =
    boost::spirit::x3::rule<class left_delimiter>() =
        boost::spirit::x3::lit('[')
        ;

// TODO ')' is also allowed.
static auto const right_delimiter =
    boost::spirit::x3::rule<class right_delimiter>() =
        boost::spirit::x3::lit(']')
        ;

static auto const wkt_separator =
    boost::spirit::x3::rule<class wkt_separator>() =
        boost::spirit::x3::lit(',')
        ;

static auto const double_quote =
    boost::spirit::x3::rule<class double_quote>() =
        boost::spirit::x3::lit('"')
        ;

static auto const non_double_quote =
    boost::spirit::x3::rule<class non_double_quote, char>() =
        ~boost::spirit::x3::char_('"')
        ;

static auto const double_quote_symbol =
    boost::spirit::x3::rule<class double_quote_symbol>() =
        double_quote >>
        double_quote
        ;
...
static auto const unsigned_integer =
    boost::spirit::x3::rule<class unsigned_integer, uint64_t>() =
        boost::spirit::x3::uint64
        ;

static auto const signed_integer =
    boost::spirit::x3::rule<class signed_integer, int64_t>() =
...
static auto const signed_float =
    boost::spirit::x3::rule<class signed_float, double>() =
        boost::spirit::x3::double_ >>
        boost::spirit::x3::eps
        ;
