...
#include "fern/algorithm/algebra/boole/detail/nor.h"
...
/*!
    ...
    @brief      Determine the boolean nor result of @a value1 and
    ...
    Result& result)
{
    ...
    nor::detail::nor<>(input_no_data_policy, output_no_data_policy,
    ...
    Result& result)
{
    ...
    OutputNoDataPolicy output_no_data_policy;
    nor<>(InputNoDataPolicy{{}, {}}, output_no_data_policy, execution_policy,
