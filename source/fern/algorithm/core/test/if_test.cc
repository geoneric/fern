...
{
    test_array_0d_2d(fa::sequential);
...
{
    test_array_0d_2d_masked(fa::sequential);
    fa::ExecutionPolicy execution_policy{fa::sequential};
...
{
    test_array_0d_2d_masked(fa::parallel);
    fa::ExecutionPolicy execution_policy{fa::parallel};
    test_array_0d_2d_masked(execution_policy);
}
...
{
    test_array_0d_0d_2d_masked(fa::sequential);
    fa::ExecutionPolicy execution_policy{fa::sequential};
...
{
    test_array_0d_0d_2d_masked(fa::parallel);
    fa::ExecutionPolicy execution_policy{fa::parallel};
    test_array_0d_0d_2d_masked(execution_policy);
}
...
{
    test_array_0d_2d_0d_masked(fa::sequential);
    fa::ExecutionPolicy execution_policy{fa::sequential};
...
{
    test_array_0d_2d_0d_masked(fa::parallel);
    fa::ExecutionPolicy execution_policy{fa::parallel};
    test_array_0d_2d_0d_masked(execution_policy);
}
...
{
    test_array_0d_2d_2d_masked(fa::sequential);
    fa::ExecutionPolicy execution_policy{fa::sequential};
...
{
    test_array_0d_2d_2d_masked(fa::parallel);
    fa::ExecutionPolicy execution_policy{fa::parallel};
    test_array_0d_2d_2d_masked(execution_policy);
}
